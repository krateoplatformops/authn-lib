...
import (
	...
	"github.com/krateoplatformops/authn-lib/auth/strategies/opaque"
	"github.com/krateoplatformops/authn-lib/auth/strategies/token"
	"github.com/krateoplatformops/authn-lib/auth/strategies/union"
...
func newAuthenticator() *authenticator {
	...
	refreshStrategy := opaque.New(gcache.New(0).Simple().Build(), db, secret, refreshOpts...)
