...
import (
	...
	"github.com/krateoplatformops/authn-lib/auth/strategies/jwt"
...
func (r *RotatedSecrets) Get(kid string) (key any, alg string, err error) {
	s, ok := r.Secrtes[kid]
	if ok {
